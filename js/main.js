...
(function() {
  var ASSETS, BEAR_IMG, ComboLabel, CountLabel, MAP_IMG, Message, MessageType, NicoLabel, StreamMessage, TimerLabel, add, game, life, padding, rand, remove, timer,
  ...
  window.onload = function() {
    ...
    game.onload = function() {
      var FLOOR_SIZE, bear, gameover, grass, scene, x, y, _i, _j, _ref, _ref1;
